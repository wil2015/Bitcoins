					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="login-form" action="/api/login" method="post" role="form" style="display: block;">
								...
								<form id="register-form" action="/api/register" method="post" role="form" style="display: none;">
									<div class="form-group">
